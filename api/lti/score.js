...
/*
  Canvas Cloud client-credentials endpoint.

  Your actual assignment line-item URL tells us the institution
  domain, so we derive the token endpoint dynamically below.
*/
...
/* ============================================================
   BUILD CANVAS TOKEN URL FROM LINE ITEM
============================================================ */
...
/* ============================================================
   BUILD SCORES ENDPOINT

   Canvas gives us the LINE ITEM endpoint:

   .../line_items/123

   AGS score submission goes to:

   .../line_items/123/scores
============================================================ */
...
async function getCanvasAccessToken(
  ...
  /*
    Canvas client-credentials JWT:

    iss = PulmoLearn tool identifier
    sub = Canvas Client ID
    aud = Canvas token endpoint

    jti prevents assertion replay.
  */
...
export default async function handler(
  ...
  try {
    ...
    */
    ...
    if (
      ...
      return res
        ...
        .json({
          ...
          error:
            "Missing access_token or lesson_id"
    ...
    /* ========================================================
       STEP 2
       GET STORED CANVAS PASSBACK CONTEXT
    ======================================================== */
    ...
    if (contextError) {
      ...
      return res
        ...
        .json({
          ...
          error:
            "Canvas launch context lookup failed",
    ...
    if (!context) {
      ...
      return res
        ...
        .json({
          ...
          error:
            "No Canvas launch context found for this lesson"
    ...
    /* ========================================================
       STEP 4
       GET CANVAS CLIENT-CREDENTIALS TOKEN
    ======================================================== */
